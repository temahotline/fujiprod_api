...
async def create_user_in_database(asyncpg_pool):
    ...
    async def create_user_in_database(user_id: str, sign_up_source: str, id_on_source: str):
        async with asyncpg_pool.acquire() as connection:
            return await connection.execute("""INSERT INTO user (user_id, sign_up_source, id_on_source) VALUES ($1, $2, $3)""",
                                            user_id, sign_up_source, id_on_source)
